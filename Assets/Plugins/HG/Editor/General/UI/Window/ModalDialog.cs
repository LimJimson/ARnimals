...
namespace HG.Window
{
    public class ModalDialog : ModalWindow
    {
        ...
        {
            _footer = new VerticalSequenceDrawer(
                new Space(10),
                new Button.Button("OK", Ok)); 
        }
        ...
        private void SetupTwoButtonFooter(Vector2 size)
        {
            ...
            _footer = new HorizontalSequenceDrawer(
                new Button.Button("Cancel", Cancel).SetWidth(buttonSize), 
                new Space(spaceSize), 
                new Button.Button("OK", Ok).SetWidth(buttonSize)); 
        }
